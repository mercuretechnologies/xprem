...
func NewPostgresBranchRepository(engine *database.Engine) *PostgresBranchRepository {
	return &PostgresBranchRepository{
		engine: engine,
	}
}

func (s *PostgresBranchRepository) InsertBranch(ctx context.Context, appId string, branchName string) (int64, error) {
...
func (s *PostgresBranchRepository) GetUpdateRefsByBranchName(ctx context.Context, appId string, branchName string) ([]types.UpdateRef, error) {
...
func (s *PostgresBranchRepository) DeleteBranchByName(ctx context.Context, appId string, branchName string) error {
...
func (s *PostgresBranchRepository) GetSurfableBranches(ctx context.Context, appId string, runtimeVersion string, platform types.Platform) ([]types.SurfableBranch, error) {
	pgAppID := ToPgUUID(appId)
...
func (s *PostgresBranchRepository) GetBranches(ctx context.Context, appId string) ([]types.BranchMapping, error) {
	pgAppID := ToPgUUID(appId)
...
func (s *PostgresBranchRepository) UpsertBranchAndRuntimeVersion(ctx context.Context, appId string, branchName string, runtimeVersion string) error {
...
func (s *PostgresBranchRepository) GetRuntimeVersionsWithUpdateStats(ctx context.Context, appId string, branchName string) ([]types.RuntimeVersionWithStats, error) {
	pgAppID := ToPgUUID(appId)
...
func (s *PostgresBranchRepository) UpdateChannelBranchMapping(ctx context.Context, appId string, channelId string, branchId string) error {
...
func (s *PostgresBranchRepository) CreateRuntimeVersion(ctx context.Context, appId string, version string) (int64, error) {
	pgAppID := ToPgUUID(appId)
...
func (s *PostgresBranchRepository) GetBranchByName(ctx context.Context, appId string, branchName string) (int64, error) {
	pgAppID := ToPgUUID(appId)
