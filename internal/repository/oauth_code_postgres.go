...
type PostgresOAuthCodeRepository struct {
	engine *database.Engine
}

func NewPostgresOAuthCodeRepository(engine *database.Engine) *PostgresOAuthCodeRepository {
	return &PostgresOAuthCodeRepository{
		engine: engine,
	}
}

func (s *PostgresOAuthCodeRepository) InsertOAuthAuthorizationCode(ctx context.Context, params InsertOAuthAuthorizationCodeParameters) error {
...
// already exchanged.
func (s *PostgresOAuthCodeRepository) ConsumeOAuthAuthorizationCode(ctx context.Context, id string) (OAuthAuthorizationCode, error) {
...
func (s *PostgresOAuthCodeRepository) DeleteExpiredOAuthAuthorizationCodes(ctx context.Context) error {
