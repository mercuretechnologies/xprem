...
func NewPostgresOAuthClientRepository(engine *database.Engine) *PostgresOAuthClientRepository {
	return &PostgresOAuthClientRepository{
		engine: engine,
	}
}

func (s *PostgresOAuthClientRepository) GetOAuthClient(ctx context.Context, id string) (OAuthClient, error) {
...
func (s *PostgresOAuthClientRepository) InsertOAuthClient(ctx context.Context, params InsertOAuthClientParameters) error {
