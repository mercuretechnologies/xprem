...
func NewPostgresAppRepository(engine *database.Engine) *PostgresAppRepository {
...
func (s *PostgresAppRepository) InsertApp(ctx context.Context, app InsertAppParameters) (string, error) {
...
func (s *PostgresAppRepository) DeleteAppByID(ctx context.Context, id string) error {
	pgAppID := ToPgUUID(id)
...
func (s *PostgresAppRepository) GetApps(ctx context.Context) ([]config.AppDescriptor, error) {
...
func (s *PostgresAppRepository) UpdateAppNameByID(ctx context.Context, id string, newName string) error {
	pgAppID := ToPgUUID(id)
...
func (s *PostgresAppRepository) UpdateAppGitURLByID(ctx context.Context, id string, gitURL string) error {
	pgAppID := ToPgUUID(id)
...
func (s *PostgresAppRepository) GetAppByID(ctx context.Context, id string) (config.AppConfig, error) {
	pgAppID := ToPgUUID(id)
