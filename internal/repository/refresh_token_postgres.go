...
func NewPostgresRefreshTokenRepository(engine *database.Engine) *PostgresRefreshTokenRepository {
	return &PostgresRefreshTokenRepository{
		engine: engine,
	}
}

func (s *PostgresRefreshTokenRepository) InsertRefreshToken(ctx context.Context, params InsertRefreshTokenParameters) error {
...
func (s *PostgresRefreshTokenRepository) RotateRefreshToken(ctx context.Context, params RotateRefreshTokenParameters) (RefreshToken, error) {
...
func (s *PostgresRefreshTokenRepository) GetRefreshToken(ctx context.Context, id string, replayGrace time.Duration) (RefreshToken, error) {
...
// token is detected.
func (s *PostgresRefreshTokenRepository) DeleteRefreshTokenFamily(ctx context.Context, familyId string) error {
...
func (s *PostgresRefreshTokenRepository) DeleteExpiredRefreshTokens(ctx context.Context, userId string) error {
