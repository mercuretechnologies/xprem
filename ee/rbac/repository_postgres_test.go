...
func setupRBACStore(t *testing.T) (*PostgresRBACRepository, *pgxpool.Pool) {
	t.Helper()
	...
	return NewPostgresRBACRepository(&database.Engine{Queries: pgdb.New(pool), DB: pool}), pool
}
